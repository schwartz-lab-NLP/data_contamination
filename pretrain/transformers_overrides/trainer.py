...
"""
Difference from Transformers' trainer: disablaing the sampler in DataLoader (line 567) to 
avoid shuffling of the data. This version is used in run_mlm_no_shuffle.py.
""""
...
class Trainer:
    ...
    def get_train_dataloader(self) -> DataLoader:
        ...
        # To train without shuffling of the data we don't use a sampler
        return DataLoader(
            self.train_dataset,
